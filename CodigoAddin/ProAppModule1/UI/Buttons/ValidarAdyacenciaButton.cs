...
{
    internal class ValidarAdyacenciaButton : Button
    {
        protected override async void OnClick()
        {
            ...
            string toolboxPath = System.IO.Path.Combine(projectDirectory, "Toolboxes", "DetectarAdyacencia.pyt");

            string toolName = "DetectarAdyacencia";
