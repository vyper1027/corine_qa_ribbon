...
{
    internal class CoberturasFueraDeAlturaButton : Button
    {
        protected override async void OnClick()
        {
            ...
            string toolboxPath = System.IO.Path.Combine(projectDirectory, "Toolboxes", "CoberturasFueraDeAltura.pyt");

            string toolName = "CoberturasFueraDeAltura";
