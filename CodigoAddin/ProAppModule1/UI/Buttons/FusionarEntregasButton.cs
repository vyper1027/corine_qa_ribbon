...
{
    internal class FusionarEntregasButton : Button
    {
        protected override async void OnClick()
        {
            ...
            string toolboxPath = System.IO.Path.Combine(projectDirectory, "Toolboxes", "UnirEntregas.pyt");

            string toolName = "FusionarEntregas";
