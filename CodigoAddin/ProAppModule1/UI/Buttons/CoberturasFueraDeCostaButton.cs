...
{
    internal class CoberturasFueraDeCostaButton : Button
    {
        protected override async void OnClick()
        {
            ...
            string toolboxPath = System.IO.Path.Combine(projectDirectory, "Toolboxes", "CoberturasFueraDeCosta.pyt");

            string toolName = "CoberturasFueraDeCosta";
